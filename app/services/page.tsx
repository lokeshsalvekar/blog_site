...
function ServiceCard({ title, description, icon, count, slug = "" }) {
  return (
    <Link href={`/services/${slug}`} className="group">
      <Card className="bg-card border-border hover:border-primary/50 transition-colors h-full">
        ...
        <CardFooter>
          <span className="text-primary text-sm group-hover:text-primary/80 transition-colors">Learn more →</span>
        </CardFooter>
      </Card>
    </Link>
  )
